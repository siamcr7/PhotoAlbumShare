...
<head>
    ...
    $ROOT_DIRECTORY = "safe-sierra-77775.herokuapp.com";
    //MUST CHANGE THIS OR THE ENTIRE PROJECT WON'T WORK!
    // Default is "php-magic-linking" because that's the name of the git repo,
    // but you can rename the root folder
    // and everything else will work as long as this variable matches the new name
